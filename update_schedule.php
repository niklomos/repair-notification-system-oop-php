...
if (isset($_POST['update'])) {
    ...
    $schedule->updated_by = $_POST['updated_by'];
...
<div class="container pb-3 ">
    <h1 class="mb-4">Scheduled Repair</h1>
    ...
    <form action="" method="post" >
        <input type="hidden" name="req_id" value="<?php echo htmlspecialchars($req['req_id']); ?>">
        <input type="hidden" name="updated_by" value="<?php echo htmlspecialchars($emp['emp_id']); ?>">
        <div class="mb-3">
            <label for="sch_date" class="form-label">Scheduled Repair<span class="text-danger">*</span></label>
            <input type="date" class="form-control" id="sch_date" name="sch_date" required>
        </div>
            <input type="hidden" class="form-control" id="emp_id" name="emp_id" value="<?php echo $emp['emp_id'] ?>">
        <button type="submit" name="update" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Add</button>
    </form>
</div>
